...
namespace XNN
{
    ...
    typedef enum
    {
        ...
        //@  same thread xnn instance share blob memory
    ...
    //@brief Config used to create xnn instance, config
    ...
    {
        ModelType model_type = MODEL_TYPE_xnn;

        //@  xnn model need two params: order is proto content, model content.
        ...
        //@  xnn model use [layer_name:string] as key-value pair,
    ...
    typedef enum
    {
        //@  normal runtime forward, only layers with varing output in xnn proto will be executed
