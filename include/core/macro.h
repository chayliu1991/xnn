...
#ifndef XNN_ARM82_SIMU

#if defined(__aarch64__) && defined(XNN_USE_NEON)
#define XNN_ARM82_A64
#elif defined(__arm__) && defined(XNN_USE_NEON)
#define XNN_ARM82_A32
#else
#define XNN_ARM82_SIMU
#endif

#endif //@ XNN_ARM82_SIMU

#else

#ifdef XNN_ARM82_SIMU
#undef XNN_ARM82_SIMU
#endif

#endif //@ XNN_ARM82

#if defined(XNN_ARM82_A64) || defined(XNN_ARM82_A32)
#define XNN_ARM82_USE_NEON
#endif
